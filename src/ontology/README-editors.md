These notes are for the EDITORS of biorealm
...
Make sure you have an ID range in the [idranges file](biorealm-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [biorealm-edit.owl](biorealm-edit.owl)

** DO NOT EDIT biorealm.obo OR biorealm.owl in the top level directory **

[../../biorealm.owl](../../biorealm.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/EnvironmentOntology/biorealm) for details.
 ...
 * [biorealm-idranges.owl](biorealm-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/biorealm_terms.txt file
...
Note: the biorealm_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as biorealm.owl and biorealm.obo and places
 ...
 * https://github.com/EnvironmentOntology/biorealm/releases
 * https://github.com/EnvironmentOntology/biorealm/releases/new
...
what is in the `owl:versionIRI` of the derived biorealm.owl (`data-version` in
biorealm.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/biorealm.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/biorealm/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/EnvironmentOntology/biorealm.svg?branch=master)](https://travis-ci.org/EnvironmentOntology/biorealm)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/EnvironmentOntology](https://travis-ci.org/profile/EnvironmentOntology)
 2. click the "Sync account" button
 3. Click the tick symbol next to biorealm
